...
const SidebarHeader = () => {
    return (
        ...
        <Flex bgColor='myBlack' w='full' h='31.8px' alignItems='center' justifyContent='center' px={1} boxShadow='0px 3px 10px 0px rgba(40,40,43,1)'>
            <Text color='textColor' fontWeight='semibold' textAlign='center'>Elixir Central Depot Modules</Text>
        </Flex>
    )
}
...
const SidebarFooter = () => {
    return (
        <Flex justifyContent='center' alignItems='center' flexDirection='column' pb={2}>
            <Text color='textColor' fontSize='xs' textAlign='center'>© 2022, Elixir Central Depot Powered by MIS</Text>
        </Flex>
    )
}